...
describe("PhoneInput", () => {
  it("renders correctly with value", () => {
    ...
    render(<PhoneInput value="+5511999998888" onChange={onChange} data-testid="phone-input" />);
  ...
  it("handles number change", () => {
    const onChange = vi.fn();
    render(<PhoneInput value="+55" onChange={onChange} data-testid="phone-input" />);
  ...
  it("infers country from value without plus", () => {
    const onChange = vi.fn();
    render(<PhoneInput value="111999998888" onChange={onChange} data-testid="phone-input" />);
  ...
  it("handles empty value", () => {
    const onChange = vi.fn();
    render(<PhoneInput value="" onChange={onChange} data-testid="phone-input" />);
  ...
  it("applies mask correctly", () => {
    const onChange = vi.fn();
    // Portugal mask: ### ### ###
    render(<PhoneInput value="+351123456789" onChange={onChange} data-testid="phone-input" />);
    const input = screen.getByTestId("phone-input") as HTMLInputElement;
