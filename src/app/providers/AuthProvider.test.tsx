...
function TestComponent() {
  ...
  return (
    <div>
      ...
      <button onClick={() => signIn('test-token', { id: 1, name: 'Test User', email: 'test@example.com' })}>
        Sign In
      </button>
...
describe('AuthProvider', () => {
  ...
  it('clears authentication state when signOut is called', async () => {
    ...
    localStorage.setItem('authUser', JSON.stringify({ id: 1, name: 'User', email: 'user@example.com' }))
